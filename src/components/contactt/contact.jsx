    ...
    <div className="row g-5 align-items-start">
      <div className="col-lg-6">
        <form className="contact-form">
          ...
          <button type="submit" className="btn btn-success btn-md px-5 py-3 fw-bold">
            Send Message
          </button>
        </form>
      </div>
        ...
        <div className="contact-info">
          <div className="d-flex align-items-start mb-5">
            <div className="icon-wrapper me-4">
              <i className="fa-solid fa-location-dot fa-2x text-success"></i>
            </div>
            <div>
          ...
          <div className="d-flex align-items-start mb-5">
            <div className="icon-wrapper me-4">
              <i className="fa-solid fa-phone fa-2x text-success"></i>
            </div>
            <div>
          ...
          <div className="d-flex align-items-start">
            <div className="icon-wrapper me-4">
              <i className="fa-solid fa-clock fa-2x text-success"></i>
            </div>
            <div>

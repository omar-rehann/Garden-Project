      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-4 footer-section">
            <div className="footer-logo"> <i className="fa-solid fa-plant-wilt"></i> Modern Green Company
</div>
...
<div className="col-lg-3 col-md-6 footer-section">
  <h5>Our Green Company Services</h5>
  <ul className="footer-links">
    <li><a href="#">Sustainable Energy Solutions</a></li>
    <li><a href="#">Eco-Friendly Product Design</a></li>
    <li><a href="#">Waste Management Services</a></li>
    <li><a href="#">Environmental Consulting</a></li>
    <li><a href="#">Green Technology Support</a></li>
  </ul>
</div>
